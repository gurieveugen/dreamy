...
$gallery_title = get_option('title_gallery_page');
?>
        ...
        <div class="bg-blue-center-title left">
            <div class="wrapper">
                <div class="title-pages left">
                    <?php if(get_post_type() =='pt_program') { ?>
                    <?php _e('Program', tk_theme_name); ?>
                    <?php } else {
                        echo $gallery_title;
                    } ?>
                </div><!--/wrapper-->
    ...
    <?php
        ...
        $category_list = wp_get_post_terms($post->ID, 'ct_gallery');
                ...
                <script type="text/javascript">
                    ...
                    <div class="latest-news-home-one left">
                        ...
                        <div class="latest-news-home-one-content right">
                             ...
                             <?php if(empty($category_list) && get_comments_number()==0) {
                                 $margin = 'add-margin';
                             } else {
                                 $margin='';
                             } ?>
                            ...
                            <div class="<?php echo $margin;  ?> latest-news-home-one-title left"><?php the_title(); ?></div><!--/latest-news-home-one-title-->
                            <div class="latest-news-home-one-category left">
                                <ul>
                                    <?php
                                            $i=1;

                                            if(!empty($category_list) && get_comments_number()!==0) {
                                    ...
                                    <li><a href="<?php echo get_term_link($the_cat->slug, 'ct_gallery'); ?>"><?php echo $the_cat->name; ?><?php echo $comma; ?></a></li>
                                    <?php $i++; } ?>
      ...
      <!--COMMENTS-->
        ...
        <div class="bg-sidebar right">
                    ...
                    <div class="bg-gallery-nav left">
                        <?php if(isset($next_post->guid)) { ?><div class="bg-gallery-prev left"><a href="<?php echo $next_post->guid; ?>"><?php _e('Prev', tk_theme_name); ?></a></div><!--/bg-gallery-prev--><?php } ?>
                        <?php if(isset($prev_post->guid)) { ?><div class="bg-gallery-next right"><a href="<?php echo $prev_post->guid; ?>"><?php _e('Next', tk_theme_name); ?></a></div><!--/bg-gallery-next--><?php } ?>
                    </div><!--/bg-gallery-nav-->


            <div class="sidebar-top left"></div><!--/sidebar-top-->
                <?php tk_get_right_sidebar('Right', 'Single Gallery'); ?>
